...
export default function Page()
{
    ...
    return <div className="animate__animated animate__fadeInLeft  md:px-5 gap-10  flex flex-col justify-center items-center">
        ...
        <div className="bg-grey flex flex-col gap-10 max-sm:py-8">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-5 px-8">
      ...
      <div className="flex flex-col gap-5 max-sm:w-1/2 max-sm:pb-14 md:gap-10 justify-center items-center">
        ...
        <Carousel className="flex overflow-auto" data={["s"]} id='Keuntungan'>
                {keutunganData.map((keuntungan, i) => <div className={`min-w-full max-sm:max-w-[50%] text-center flex flex-col gap-3 justify-center  items-center min-h-full  `} key={"Keuntungan " + i}>
