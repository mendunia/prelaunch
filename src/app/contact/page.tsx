...
export default function Page()
{
    ...
    return <div className="w-full min-h-full h-full max-sm:p-10 py-2 gap-10 flex flex-col justify-center items-center">
        <div className="max-sm:hidden flex justify-center w-full h-full max-h-96">
            <Image className="w-full" src={"/hero/banner-contact.png"} width={1280} height={360} alt="hero banner contact"/>
        </div>
        <div className="flex flex-col md:flex-row gap-10 lg:gap-32 lg:py-10">
            <div className="flex flex-col justify-center md:justify-start md:items-start md:text-start items-center gap-5">
                <div className="flex flex-col justify-center md:items-start items-center gap-2">
                    <h1 className="text-2xl lg:text-5xl text-merah-inti font-semibold">Mari Terhubung</h1>
                    <div className="h-1 bg-merah-inti w-3/4"/>

                </div>
                <p className="text-center md:text-start text-xs lg:text-lg leading-5">
                ...
                {contactData.map((data, i) => <div key={data.title} className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-1 justify-between text-xs lg:text-base">
